#
# Be sure to run `pod lib lint KMLDataTypes.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'KMLDataTypes'
  s.version          = '0.1.8'
  s.summary          = 'Set of type class definitions for use with Kinetix ML computer vision products'
